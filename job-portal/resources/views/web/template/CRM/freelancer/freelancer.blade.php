                                                        ...
                                                        <ul class="list-wrapper pd-lr-15">
                                                            <li class="tl-item">
                                                                ...
                                                                <div class="tl-label panel widget light-widget panel-bd-left">
                                                                    <div class="panel-body"> <img alt="example image" class="tl-img img-right img-circle  mgtp-5" src="{{url('web/img/avatar/avatar-5.jpg')}}">
                                                                        ...
                                                                        <div class="comments">
                                                                            <div class="content-list content-image">
                                                                                <ul class="list-wrapper no-bd-btm">
                                                                                    <li>
                                                                                        <div class="menu-icon"><img src="{{url('web/img/avatar/avatar.jpg')}}" alt="example image"></div>
                                                                            ...
                                                                            <div class="reply-comment">
                                                                                <div class="content-list content-image">
                                                                                    <div class="list-wrapper">
                                                                                        <div>
                                                                                            <div class="menu-icon"><img src="{{url('web/img/avatar/avatar-5.jpg')}}" alt="example image"></div>
                                                                                            <div class="menu-text">
                                                            ...
                                                            <li class="tl-item">
                                                                ...
                                                                <div class="tl-label panel widget light-widget panel-bd-left vd_bdl-red">
                                                                    <div class="panel-body"> <img alt="example image" class="tl-img img-right img-circle  mgtp-5" src="{{url('web/img/avatar/avatar.jpg')}}">
                                                                        ...
                                                                        <div class="tl-post-image mgbt-xs-20"> <a data-rel="prettyPhoto[2]" href="{{url('web/img/blog/01-large.jpg')}}"> <img src="{{url('web/img/blog/01-large.jpg')}}" alt="example image"> </a> </div>
                                                                        ...
                                                                        <div class="tl-post-friends">
                                                                            <div class="content-grid column-xs-3 column-sm-4 column-md-5 column-lg-6 height-xs-3">
                                                                                <ul class="list-wrapper">
                                                                                    <li> <a href="#">
                                                                                            <div class="menu-icon"><img alt="example image" src="{{url('web/img/avatar/avatar.jpg')}}"></div>
                                                                                        </a>
                                                                                    ...
                                                                                    <li> <a href="#">
                                                                                            <div class="menu-icon"><img alt="example image" src="{{url('web/img/avatar/avatar-2.jpg')}}"></div>
                                                                                        </a>
                                                                                    ...
                                                                                    <li> <a href="#">
                                                                                            <div class="menu-icon"><img alt="example image" src="{{url('web/img/avatar/avatar-3.jpg')}}"></div>
                                                                                        </a>
                                                                                    ...
                                                                                    <li> <a href="#">
                                                                                            <div class="menu-icon"><img alt="example image" src="{{url('web/img/avatar/avatar-4.jpg')}}"></div>
                                                                                        </a>
                                                                                    ...
                                                                                    <li> <a href="#">
                                                                                            <div class="menu-icon"><img alt="example image" src="{{url('web/img/avatar/avatar-5.jpg')}}"></div>
                                                                                        </a>
                                                                                    ...
                                                                                    <li> <a href="#">
                                                                                            <div class="menu-icon"><img alt="example image" src="{{url('web/img/avatar/avatar-6.jpg')}}"></div>
                                                                                        </a>
                                                            ...
                                                            <div class="form-group" style="padding-top: 20px ; padding-bottom: 40px  ; margin-top: 30px">
                                                                ...
                                                                <div class="col-sm-9 controls">
                                                                    <div id="tags1584440712527_tagsinput" class="tagsinput" style="width: auto; height: 100px;">
                                                                        ...
                                                                        <span class="tag"><img src="{{asset('web/img/logo.png')}}"><a href="#" title="Removing tag">x</a></span>

...
<!-- Mirrored from www.venmond.com/demo/vendroid/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2017 07:22:22 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8" />
    <title>CephZone | DashBoard</title>
    ...
    <!-- Fav and touch icons -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{asset('web/crm/free/img/ico/apple-touch-icon-144-precomposed.html')}}">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{asset('web/crm/free/img/ico/apple-touch-icon-114-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{asset('web/crm/free/img/ico/apple-touch-icon-72-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" href="{{asset('web/crm/free/img/ico/apple-touch-icon-57-precomposed.png')}}">
    <link rel="shortcut icon" href="{{asset('web/crm/free/img/ico/favicon.png')}}">


    <!-- CSS -->

    <!-- Bootstrap & FontAwesome & Entypo CSS -->
    <link href="{{asset('web/crm/free/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('web/crm/free/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css">
    <link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <!--[if IE 7]><link type="text/css" rel="stylesheet" href="{{asset('web/crm/free/css/font-awesome-ie7.min.css')}}"><![endif]-->
    <link href="{{asset('web/crm/free/css/font-entypo.css')}}" rel="stylesheet" type="text/css">

    <!-- Fonts CSS -->
    <link href="{{asset('web/crm/free/css/fonts.css')}}"  rel="stylesheet" type="text/css">

    <!-- Plugin CSS -->
    <link href="{{asset('web/crm/free/plugins/jquery-ui/jquery-ui.custom.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('web/crm/free/plugins/prettyPhoto-plugin/css/prettyPhoto.css')}}" rel="stylesheet" type="text/css">
    ...
    <!-- Specific CSS -->
    <link href="{{asset('web/crm/free/plugins/fullcalendar/fullcalendar.css')}}" rel="stylesheet" type="text/css"><link href="plugins/fullcalendar/fullcalendar.print.css" rel="stylesheet" type="text/css"><link href="plugins/introjs/css/introjs.min.css" rel="stylesheet" type="text/css">

    <!-- Theme CSS -->
    <link href="{{asset('web/crm/free/css/theme.min.css')}}" rel="stylesheet" type="text/css">
    <!--[if IE]> <link href="{{asset('webcrm/free//css/ie.css')}}" rel="stylesheet" > <![endif]-->
    <link href="{{asset('web/crm/free/css/chrome.css')}}" rel="stylesheet" type="text/chrome"> <!-- chrome only css -->



    <!-- Responsive CSS -->
    <link href="{{asset('web/crm/free/css/theme-responsive.min.css')}}" rel="stylesheet" type="text/css">
    ...
    <!-- Custom CSS -->
    <link href="{{asset('web/crm/free/custom/custom.css')}}" rel="stylesheet" type="text/css">



    <!-- Head SCRIPTS -->
    <script type="text/javascript" src="{{asset('web/crm/free/js/modernizr.js')}}"></script>
    <script type="text/javascript" src="{{asset('web/crm/free/js/mobile-detect.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('web/crm/free/js/mobile-detect-modernizr.js')}}"></script>
    <link href="{{asset('web/crm/free/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('web/crm/free/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css">
    <!--[if IE 7]><link type="text/css" rel="stylesheet" href="{{asset('web/crm/free/css/font-awesome-ie7.min.css')}}"><![endif]-->
    <link href="{{asset('web/crm/free/css/font-entypo.css')}}" rel="stylesheet" type="text/css">
    ...
    <!-- Theme CSS -->
    <link href="{{asset('web/crm/free/css/theme.min.css')}}" rel="stylesheet" type="text/css">
    <!--[if IE]> <link href="{{asset('web/crm/free/css/ie.css')}}" rel="stylesheet" > <![endif]-->
    <link href="{{asset('web/crm/free/css/chrome.css')}}" rel="stylesheet" type="text/chrome"> <!-- chrome only css -->
    ...
    <!--[if lt IE 9]>
    <script type="text/javascript" src="{{asset('web/crm/free/js/html5shiv.js')}}"></script>
    <script type="text/javascript" src="{{asset('web/crm/free/js/respond.min.js')}}"></script>
    <![endif]-->
...
<div class="vd_body">
            ...
            <div class="container ">
                <div class="vd_top-nav vd_nav-width  ">
                    <div class="vd_panel-header">
                        <div class="logo">
                            <a href="index-2.html"><img alt="logo" src="{{URL::to('web/img/logo.png')}}"></a>
                        </div>
                        <!-- logo -->
                        ...
                        <div class="col-sm-7 col-xs-12">
                            ...
                            <div class="vd_menu-search">
                                <form id="search-box" method="post" action="#">
                                    <input type="text" name="search" class="vd_menu-search-text width-50" placeholder="Search Peoples, Jobs, Company, Groups, Pages">
                                                    ...
                                                    <ul class="list-wrapper">
                                                        ...
                                                        <li>
                                                            <label>
                                                                ...
                                                                <span>Jobs </span></label>
                                                        </li>
                                                        <li>
                                                            <label>
                                                                <input type="checkbox" value="illustrations">
                                                                <span>Groups</span></label>
                                                        </li>
                                                        <li>
                                                            <label>
                                                ...
                                                <div class="child-menu">
                                                    ...
                                                    <div class="content-grid column-xs-2 column-sm-3 height-xs-4">
                                                        <div data-rel="scroll">
                                                            <ul class="list-wrapper">
                                                                <li> <a href="#">
                                                                        <div class="menu-icon"><img alt="example image" src="{{URL::to('web/img/avatar/avatar.jpg')}}"></div>
                                                                    </a>
                                                                ...
                                                                <li class="warning">
                                                                    <a href="#">
                                                                        <div class="menu-icon"><img alt="example image" src="{{URL::to('web/img/avatar/avatar-2.jpg')}}"></div>
                                                                    </a>
                                                              ...
                                                              <span class="menu-action-icon vd_red vd_bd-red" data-original-title="Reject" data-toggle="tooltip" data-placement="bottom">
                                                                ...
                                                                <li> <a href="#">
                                                                        <div class="menu-icon"><img alt="example image" src="{{URL::to('web/img/avatar/avatar-3.jpg')}}"></div>
                                                                    </a>
                                                            ...
                                                            <span class="menu-action-icon vd_red vd_bd-red" data-original-title="Reject" data-toggle="tooltip" data-placement="bottom">
                                                              <i class="fa fa-times"></i>
                                                                ...
                                                                <li> <a href="#">
                                                                        <div class="menu-icon"><img alt="example image" src="{{URL::to('web/img/avatar/avatar-4.jpg')}}"></div>
                                                                    </a>
                                                          ...
                                                          <span class="menu-action-icon vd_red vd_bd-red" data-original-title="Reject" data-toggle="tooltip" data-placement="bottom">
                                                            <i class="fa fa-times"></i>
                                                                ...
                                                                <li> <a href="#">
                                                                        <div class="menu-icon"><img alt="example image" src="{{URL::to('web/img/avatar/avatar-5.jpg')}}"></div>
                                                                    </a>
                                                        ...
                                                        <span class="menu-action-icon vd_red vd_bd-red" data-original-title="Reject" data-toggle="tooltip" data-placement="bottom">
                                                          <i class="fa fa-times"></i>
                                                                ...
                                                                <li> <a href="#">
                                                                        <div class="menu-icon"><img alt="example image" src="{{URL::to('web/img/avatar/avatar-6.jpg')}}"></div>
                                                                    </a>
                                                      ...
                                                      <span class="menu-action-icon vd_red vd_bd-red" data-original-title="Reject" data-toggle="tooltip" data-placement="bottom">
                                                        <i class="fa fa-times"></i>
                                                                ...
                                                                <li> <a href="#">
                                                                        <div class="menu-icon"><img alt="example image" src="{{URL::to('web/img/avatar/avatar-7.jpg')}}"></div>
                                                                    </a>
                                                    ...
                                                    <span class="menu-action-icon vd_red vd_bd-red" data-original-title="Reject" data-toggle="tooltip" data-placement="bottom">
                                                      <i class="fa fa-times"></i>
                                                                ...
                                                                <li> <a href="#">
                                                                        <div class="menu-icon"><img alt="example image" src="{{URL::to('web/img/avatar/avatar-8.jpg')}}"></div>
                                                                    </a>
                                                    ...
                                                    <div class="content-list">
                                                        <div  data-rel="scroll">
                                                            <ul  class="list-wrapper pd-lr-10">
                                                                ...
                                                                <li> <a href="#">
                                                                        <div class="menu-icon vd_green"><img alt="example image" src="{{URL::to('web/img/avatar/avatar.jpg')}}"></div>
    ...
    <span  class="mega-image">
      <img src="{{URL::to('web/img/avatar/avatar.jpg')}}" alt="example image" />
    </span>
    <span class="mega-name">
       {{ Auth::user()->first_name }}  <i class="fa fa-caret-down fa-fw"></i>
    </span>
                                            </a>
      ...
      <i class="fa fa-sort-amount-asc"></i>
                    ...
                    <div class="vd_menu">
                        <ul>
                            ...
                            <li>
                                <a href="http://cephzonecrm.com/admin/authentication" target="_blank">
                                    <span class="menu-icon"><i class="fa fa-braille"></i></span>
                                    <span class="menu-text">Go TO CRM</span>
                                    <span class="menu-badge"><span class="badge vd_bg-red">78</span></span>
                                </a>
                            </li>

                            <li>
                                <a href="{{route('web.freelancer.index')}}" >
                            ...
                            <li>
                                <a href="{{route('web.freelancer.networkPage')}}" >
                            ...
                            <li>
                                <a href="{{route('web.freelancer.profilePage')}}" >
                            ...
                            <li>
                                <a href="{{route('web.freelancer.profileView')}}" >
                            ...
                            <li>
                                <a href="{{route('web.freelancer.myJob')}}" >
                            ...
                            @if(Auth::user()->user_type == 'Freelancer'|| Auth::user()->user_type == 'Recruiter')
                            <li>
                                <a href="{{route('web.freelancer.allCandidates')}}" >
                            ...
                            <li>
                                <a href="{{route('web.freelancer.myProjects')}}" >
                            ...
                            <li>
                                <a href="resume.php" >
                                    ...
                                    <span class="menu-text">Manage Resume</span>
                            ...
                            <li>
                                <a href="#" >
                                    ...
                                    <span class="menu-text">My Mails</span>
                ...
                <div class="vd_menu vd_navbar-bottom-widget">
                    <ul>
                        <li>
                            <a href="{{route('web.home.logoutUser')}}">
                ...
                <div class="navbar-menu clearfix">
                    <div class="content-list content-image content-chat">
                        <ul class="list-wrapper no-bd-btm pd-lr-10">
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon"><img src="{{URL::to('web/img/avatar/avatar.jpg')}}" alt="example image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon"><img src="{{URL::to('web/img/avatar/avatar-2.jpg')}}" alt="example image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon"><img src="{{URL::to('web/img/avatar/avatar-3.jpg')}}" alt="example image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon"><img src="{{URL::to('web/img/avatar/avatar-4.jpg')}}" alt="example image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon"><img src="{{URL::to('web/img/avatar/avatar-5.jpg')}}" alt="example image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon"><img src="{{URL::to('web/img/avatar/avatar-6.jpg')}}" alt="example image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon"><img src="{{URL::to('web/img/avatar/avatar-7.jpg')}}" alt="example image"></div>
                            ...
                            <li>
                                <a href="#">
                                    <div class="menu-icon"><img src="{{URL::to('web/img/avatar/avatar-8.jpg')}}" alt="example image"></div>

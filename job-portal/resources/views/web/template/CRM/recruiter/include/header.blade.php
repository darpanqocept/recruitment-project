   ...
   <html class="ie ie9">
      ...
      <html>
         ...
         <head>
            ...
            <!--[if IE 7]>
            <link type="text/css" rel="stylesheet" href="{{asset('web/crm/free/css/font-awesome-ie7.min.css')}}">
            <![endif]-->
            ...
            <link href="{{asset('web/plugins/introjs/css/introjs.min.css')}}" rel="stylesheet" type="text/css">
            <!-- Theme CSS -->
            <link href="{{asset('web/crm/free/css/theme.min.css')}}" rel="stylesheet" type="text/css">
            <!--[if IE]> 
            <link href="{{asset('webcrm/free//css/ie.css')}}" rel="stylesheet" >
            <![endif]-->
            <link href="{{asset('web/crm/free/css/chrome.css')}}" rel="stylesheet" type="text/chrome">
            <!-- chrome only css -->
            <!-- Responsive CSS -->
            ...
            <link href="{{asset('web/crm/free/css/theme.min.css')}}" rel="stylesheet" type="text/css">
            <!--[if IE]> 
            <link href="{{asset('web/crm/free/css/ie.css')}}" rel="stylesheet" >
            <![endif]-->
            <link href="{{asset('web/crm/free/css/chrome.css')}}" rel="stylesheet" type="text/chrome">
            <!-- chrome only css -->
            <!-- Responsive CSS -->
                              ...
                              <div class="vd_menu-search">
                                 <form id="search-box" method="post" action="#">
                                    ...
                                    <div class="vd_menu-search-category">
                                       <span data-action="click-trigger"> <span class="separator"></span> <span class="text">Category</span> <span class="icon"> <i class="fa fa-caret-down"></i></span> </span>
                                    ...
                                    <div class="vd_menu-search-category">
                                       <span data-action="click-trigger"> <span class="separator"></span> <span class="text">Location</span> <span class="icon"> <i class="fa fa-caret-down"></i></span> </span>
                                       <div class="vd_mega-menu-content width-xs-2 center-xs-2 right-sm" data-action="click-target">
                                          <div class="child-menu">
                                             <div class="content-list content-menu content">
                                                <ul class="list-wrapper">
                                    ...
                                    <div class="vd_menu-search-category">
                                       <span data-action="click-trigger"> <span class="separator"></span> <span class="text">Domain</span> <span class="icon"> <i class="fa fa-caret-down"></i></span> </span>
                                       <div class="vd_mega-menu-content width-xs-2 center-xs-2 right-sm" data-action="click-target">
                                          <div class="child-menu">
                                             <div class="content-list content-menu content">
                                                <ul class="list-wrapper">
               ...
               <div class="navbar-menu clearfix">
                  ...
                  <div class="vd_menu">
                     <ul>
                        ...
                        <li>
                           <a href="{{route('web.recruiter.index')}}" >
                           <span class="menu-icon"><i class="fa fa-dashboard"></i></span>
                           <span class="menu-text">Dashboard1</span>
                           </a>
                           <div class="child-menu"  data-action="click-target">
                           </div>
                        </li>
                        <li>
                           <a href="{{route('web.recruiter.network')}}" >
                        ...
                        <li>
                           <a href="{{route('web.recruiter.profile')}}" >
                        ...
                        <li>
                           <a href="{{route('web.recruiter.my-job')}}" >
                        ...
                        @if(Auth::user()->user_type == 'recruiter'|| Auth::user()->user_type == 'Recruiter')
                        <li>
                           <a href="{{route('web.recruiter.allCandidates')}}" >
                        ...
                        <li>
                           <a href="{{route('web.recruiter.myProjects')}}" >

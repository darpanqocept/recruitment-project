            ...
            <div class="vd_title-section clearfix">
                <div class="vd_panel-header">
                    ...
                    <div class="vd_panel-menu  hidden-xs">
                        ...
                        <button class="btn btn-primary " data-toggle="modal" data-target="#myModal2" style="text-align: right;" > Post Feed </button>
                    ...
                    <div class="col-sm-9">
                        <div class="tabs widget">
                            <ul class="nav nav-tabs widget">
                                ...
                                <li class="active" > <a data-toggle="tab" href="#feeds-tab"> Feeds <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
                                <li  > <a data-toggle="tab" href="#people-tab"> Peoples <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
                                    ...
                                    <div class="pd-20">
                                        <div class="panel-body">
                                            ...
                                            <ul class="nav nav-pills">
                                                <li class="active"><a href="#tab41" data-toggle="tab">Recomended</a></li>
                                                <li><a href="#tab42" data-toggle="tab">Similar Role</a></li>
                                                <li><a href="#tab43" data-toggle="tab">From Your Area</a></li>
                                                <li><a href="#tab44" data-toggle="tab">From Your Domain </a></li>
                                            </ul>
                                            <br>
...
<button type="button" class="btn vd_btn vd_bg-green "  >Unblock</button>
                                ...
                                <div id="feeds-tab" class="tab-pane active" style="white">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header vd_bg-blue vd_white">
                    ...
                    <h4 class="modal-title" id="myModalLabel"> Post Feed</h4>
                </div>

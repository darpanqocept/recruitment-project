...
<head>
    ...
    <!-- Fav and touch icons -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{asset('web/crm/img/ico/apple-touch-icon-144-precomposed.html')}}">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{asset('web/crm/img/ico/apple-touch-icon-114-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{asset('web/crm/img/ico/apple-touch-icon-72-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" href="{{asset('web/crm/img/ico/apple-touch-icon-57-precomposed.png')}}">
    ...
    <link href="{{asset('web/crm/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('web/crm/css/font-awesome.min.css')}}" rel="stylesheet" type="text/css">
    <!--[if IE 7]><link type="text/css" rel="stylesheet" href="{{asset('web/crm/css/font-awesome-ie7.min.css')}}"><![endif]-->
    <link href="{{asset('web/crm/css/font-entypo.css')}}" rel="stylesheet" type="text/css">

    <!-- Fonts CSS -->
    <link href="{{asset('web/crm/css/fonts.css')}}"  rel="stylesheet" type="text/css">

    <!-- Plugin CSS -->
    <link href="{{asset('web/crm/plugins/jquery-ui/jquery-ui.custom.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('web/crm/plugins/prettyPhoto-plugin/css/prettyPhoto.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('web/crm/plugins/isotope/css/isotope.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('web/crm/plugins/pnotify/css/jquery.pnotify.css')}}" media="screen" rel="stylesheet" type="text/css">
    <link href="{{asset('web/crm/plugins/google-code-prettify/prettify.css')}}" rel="stylesheet" type="text/css">


    <link href="{{asset('web/crm/plugins/mCustomScrollbar/jquery.mCustomScrollbar.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('web/crm/plugins/tagsInput/jquery.tagsinput.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('web/crm/plugins/bootstrap-switch/bootstrap-switch.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('web/crm/plugins/daterangepicker/daterangepicker-bs3.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('web/crm/plugins/bootstrap-timepicker/bootstrap-timepicker.min.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('web/crm/plugins/colorpicker/css/colorpicker.css')}}" rel="stylesheet" type="text/css">

    <!-- Specific CSS -->


    <!-- Theme CSS -->
    <link href="{{asset('web/crm/css/theme.min.css')}}" rel="stylesheet" type="text/css">
    <!--[if IE]> <link href="{{asset('web/crm/css/ie.css')}}" rel="stylesheet" > <![endif]-->
    <link href="{{asset('web/crm/css/chrome.css')}}" rel="stylesheet" type="text/chrome"> <!-- chrome only css -->



    <!-- Responsive CSS -->
    <link href="{{asset('web/crm/css/theme-responsive.min.css')}}" rel="stylesheet" type="text/css">
    ...
    <!-- Custom CSS -->
    <link href="{{asset('web/crm/custom/custom.css')}}" rel="stylesheet" type="text/css">



    <!-- Head SCRIPTS -->
    <script type="text/javascript" src="{{asset('web/crm/js/modernizr.js')}}"></script>
    <script type="text/javascript" src="{{asset('web/crm/js/mobile-detect.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('web/crm/js/mobile-detect-modernizr.js')}}"></script>

    <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!--[if lt IE 9]>
    <script type="text/javascript" src="{{asset('web/crm/js/html5shiv.js')}}"></script>
    <script type="text/javascript" src="{{asset('web/crm/js/respond.min.js')}}"></script>
    <![endif]-->
                ...
                <div class="row">
                    <div class=" col-xs-12">
                        <div class="copyright text-center">
                            <P style="color:black" >Copyright &copy;2020 CephZone. All Rights Reserved </P>
                        </div>
                    </div>
                </div><!-- row -->
            </div><!-- container -->
...
<script type="text/javascript" src="{{asset('web/crm/js/jquery.js')}}"></script>
<!--[if lt IE 9]>
<script type="text/javascript" src="{{asset('web/crm/js/excanvas.js')}}"></script>
<![endif]-->
<script type="text/javascript" src="{{asset('web/crm/js/bootstrap.min.js')}}"></script>
<script type="text/javascript" src='{{asset('web/crm/plugins/jquery-ui/jquery-ui.custom.min.js')}}'></script>
<script type="text/javascript" src="{{asset('web/crm/plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js')}}"></script>

<script type="text/javascript" src="{{asset('web/crm/js/caroufredsel.js')}}"></script>
<script type="text/javascript" src="{{asset('web/crm/js/plugins.js')}}"></script>

<script type="text/javascript" src="{{asset('web/crm/plugins/breakpoints/breakpoints.js')}}"></script>
<script type="text/javascript" src="{{asset('web/crm/plugins/dataTables/jquery.dataTables.min.js')}}"></script>
<script type="text/javascript" src="{{asset('web/crm/plugins/prettyPhoto-plugin/js/jquery.prettyPhoto.js')}}"></script>

<script type="text/javascript" src="{{asset('web/crm/plugins/mCustomScrollbar/jquery.mCustomScrollbar.concat.min.js')}}"></script>
<script type="text/javascript" src="{{asset('web/crm/plugins/tagsInput/jquery.tagsinput.min.js')}}"></script>
<script type="text/javascript" src="{{asset('web/crm/plugins/bootstrap-switch/bootstrap-switch.min.js')}}"></script>
<script type="text/javascript" src="{{asset('web/crm/plugins/blockUI/jquery.blockUI.js')}}"></script>
<script type="text/javascript" src="{{asset('web/crm/plugins/pnotify/js/jquery.pnotify.min.js')}}"></script>

<script type="text/javascript" src="{{asset('web/crm/js/theme.js')}}"></script>
<script type="text/javascript" src="{{asset('web/crm/custom/custom.js')}}"></script>

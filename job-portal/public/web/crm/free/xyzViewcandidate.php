                ...
                <div class="child-menu">
                  <div class="content-list content-menu">
                    <ul class="list-wrapper pd-lr-10">
                      <li> <a href="abcViewcandidate.php"> <div class="menu-icon"><i class=" fa fa-user"></i></div> <div class="menu-text">WizRich Solution</div> </a> </li>
                         <li> <a href="xyzViewcandidate.php"> <div class="menu-icon"><i class=" fa fa-user"></i></div> <div class="menu-text">Codester Solution</div> </a> </li>
                                             <li> <a href="jklViewcandidate.php"> <div class="menu-icon"><i class=" fa fa-user"></i></div> <div class="menu-text">Infosys</div> </a> </li>
                    </ul>
                  </div>
                </div>
              </div>
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6 mgbt-sm-15">
							<div class="vd_status-widget vd_bg-blue widget">
								...
								<a class="panel-body" href="xyzViewcandidate.php">
									<div class="clearfix">
							...
							<div class="col-lg-3 col-md-6 col-sm-6 mgbt-sm-15">
								<div class="vd_status-widget vd_bg-green widget">
									...
									<a class="panel-body" href="xyzsavedcandidate.php">
										<div class="clearfix">
											<span class="menu-icon">
								...
								<div class="col-lg-3 col-md-6 col-sm-6 mgbt-xs-15">
									<div class="vd_status-widget vd_bg-yellow widget">
										...
										<a class="panel-body" href="xyzappliedcandidate.php">
											<div class="clearfix">
												<span class="menu-icon">
									...
									<div class="col-lg-3 col-md-6 col-sm-6 mgbt-xs-15">
										<div class="vd_status-widget vd_bg-red widget">
											...
											<a class="panel-body" href="xyzshortlistedcandidate.php">
												<div class="clearfix">
													<span class="menu-icon">
  ...
  <div class="tab-content  mgbt-xs-20">
    ...
    <div class="tab-pane active " id="tab32"> 
     <div class="content-grid column-xs-3 column-sm-4 column-md-4 column-lg-6 height-xs-4 mgbt-xs-20">  
                ...
                <div class="row" style="display: one;">                 <div class="col-md-12">
                      <div class="panel widget">
                        <div class="panel-heading vd_bg-grey">
                           ...
                           <span class="menu-icon"> <input type="checkbox" id="chk" name="" value=""> </span>                                                 
...
<select id="cars">
  <option value="volvo">Move to</option>
  <option value="saab">Excel</option>
  <option value="opel">CRM</option>
  <option value="audi">Mail</option>
  <option value="audi">Saved Candidate</option>
  <option value="audi">Shortlist Candidate</option>
</select>                                                
                                                </td>
                                                                                              <td style=" padding: 8px ">
...
<select id="cars">
  ...
  <option value="audi">100</option>
            ...
            <table class="table table-hover" >
                            <thead>
                              <tr>
                                ...
                                <th>  <input type="checkbox" id="chk" name="" value=""></th>
                                <th>Name</th>
                                <th>Picture</th>
                                <th>Education</th>
    
                              
                                                            <th>Current Employement  </th>
            ...
            <th>   </th>
                            ...
                            <tbody>
                              <tr>
                                <td> <input type="checkbox" id="chk" name="" value=""></td>
                                <td>Satyam Singh Rishabh<br>
...
<i class="fa fa-star" aria-hidden="true"></i>
<i class="fa fa-star" aria-hidden="true"></i>  
&nbsp;&nbsp;&nbsp;&nbsp;                                                            </b><i class="fa fa-mobile fa-lg"></i><i class="fa fa-check" aria-hidden="true" style="color: green"></i>&nbsp;|&nbsp;<i class="fa fa-envelope fa-lg" aria-hidden="true"></i>
<i class="fa fa-check-square" aria-hidden="true" style="color: green"></i>&nbsp;&nbsp;&nbsp;<br> Score : 900
                                                                
                                                                <br><h6 style="color: blue" >Location : Mumbai</h6>
                                                                <h5  ><b style="color: green">Connected</b>&nbsp;&nbsp;<i class="fa fa-comments-o" aria-hidden="true"></i>
</h5>
                                                           
                                                            </td>
                                <td class="center">
                                                                
                                                                <img src="img/avatar/avatar.jpg" alt="dsadas" class="img-responsive  "  style="padding:0 " /></td>
                    
                              
                                                            <td class="center"><i class="fa fa-graduation-cap" aria-hidden="true"></i>
&nbsp;&nbsp;B.Sc(Computer Science)</td>
                                <td class="center"><i class="fa fa-briefcase" aria-hidden="true"></i>
&nbsp;&nbsp;CephZone<br>
                                                            <b>Experience:</b> 5 yrs<br>
                                                              <b>Title:</b>  UI / UX Developer<br>
                                                                <b>Projects:</b> 18
                                                            </td>

                                <td class="center">Closer, Time Management,<br> Inbound, Follow Ups,<br> Outbound Calling</td>
                                                                                            <td class="center">
                                                                
                                                                Codester </td>
                                  <td class="center"><i class="fa fa-trash" style="color: red" aria-hidden="true"></i><br>

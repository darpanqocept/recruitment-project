          ...
          <div class="container ">
            <div class="vd_top-nav vd_nav-width  ">
              <div class="vd_panel-header">
               <div class="logo">
                 <a href="index-2.html"><img alt="logo" src="img/logo.png"></a>
               </div>
               <!-- logo -->
           ...
           <div class="col-sm-7 col-xs-12">
            ...
            <div class="vd_menu-search">
              <form id="search-box" method="post" action="#">
                <input type="text" name="search" class="vd_menu-search-text width-50" placeholder="Search Job">
    ...
    <ul>
      ...
      <li>
        <a href="searchjob.php" >
          ...
          <span class="menu-text">Search Job</span>
          ...
          <ul>  
            ...
            <li>
              <a href="skin-nav-medium-profile-dark.html">
                ...
                <span class="menu-badge"><span class="badge vd_bg-red">New</span></span>                                    
              </a>
            </li>
            <li>
              <a href="skin-nav-medium-profile-dark.html">

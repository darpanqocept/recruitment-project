		...
		<div class="vd_content clearfix">
			...
			<div class="vd_title-section clearfix">
				<div class="vd_panel-header">
					...
					<small class="subtitle">Create, Post, Repost Job Posts, Affiliate jobs and companing also</small> </div>
				</div>
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6 mgbt-sm-15">
							<div class="vd_status-widget vd_bg-blue widget">
								...
								<a class="panel-body" href="Jobs.php">
									<div class="clearfix">
							...
							<div class="col-lg-3 col-md-6 col-sm-6 mgbt-sm-15">
								<div class="vd_status-widget vd_bg-green widget">
									...
									<a class="panel-body" href="sharedjobs.php">
										<div class="clearfix">
											<span class="menu-icon">
								...
								<div class="col-lg-3 col-md-6 col-sm-6 mgbt-xs-15">
									<div class="vd_status-widget vd_bg-yellow widget">
										...
										<a class="panel-body" href="savedjobs.php">
											<div class="clearfix">
												<span class="menu-icon">
									...
									<div class="col-lg-3 col-md-6 col-sm-6 mgbt-xs-15">
										<div class="vd_status-widget vd_bg-red widget">
											...
											<a class="panel-body" href="appliedjobs.php">
												<div class="clearfix">
													<span class="menu-icon">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 mgbt-sm-15">
							<div class="vd_status-widget vd_bg-yellow widget">
								...
								<a class="panel-body" href="recommendjobs.php">
									<div class="clearfix">
										<span class="menu-icon">
							...
							<div class="col-lg-3 col-md-6 col-sm-6 mgbt-sm-15">
								<div class="vd_status-widget vd_bg-blue widget">
									...
									<a class="panel-body" href="jobnotification.php">
										<div class="clearfix">
											<span class="menu-icon">
								...
								<div class="col-lg-3 col-md-6 col-sm-6 mgbt-xs-15">
									<div class="vd_status-widget vd_bg-yellow widget">
										...
										<a class="panel-body" href="viewedprofile.php">
											<div class="clearfix">
												<span class="menu-icon">
									...
									<div class="vd_status-widget vd_bg-green widget">
										...
										<a class="panel-body" href="Freelancingjobs.php">
											<div class="clearfix">
												<span class="menu-icon">
										...
										<div class="col-md-12">
											<div class="panel widget">
												<div class="panel-heading vd_bg-grey">
													<h3 class="panel-title"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> All Afiliate Jobs </h3>
												</div>
													...
													<table class="table table-hover">
														...
														<tbody>
															<tr>
																...
																<td class="center">Affiliate</td>
																<td class="center">Sales Executive Officer</td>
																<td class="center"> Education Background: Science, IT B.tech, Any Tech Course, MBA, etc. </td>
                                                            <td class="center">9 yrs</td>
																<td class="center">900000 P.A.</td>
																<td class="center">Mumbai</td>
                                                            ...
                                                            <td class="center">9 yrs</td>
																...
																<td class="center">Mumbai</td>
																<td class="center">IT</td>
																<td class="center"><span class="label label-warning">Inactive</span></td>
																<td class="menu-action"><a data-original-title="view" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-green vd_green"> <i class="fa fa-eye"></i> </a> <a data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-yellow vd_yellow"> <i class="fa fa-pencil"></i> </a> <a data-original-title="delete" data-toggle="tooltip" data-placement="top" class="btn menu-icon vd_bd-red vd_red"> <i class="fa fa-times"></i> </a></td>
															</tr>

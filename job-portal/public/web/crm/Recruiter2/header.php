    ...
    <ul>
      ...
      <li>
        <a href="#" >
          ...
          <span class="menu-text">My Job Applications</span>
      ...
      <li>
        <a href="#" >
          <span class="menu-icon"><i class="fa fa-fire"></i></span> 

          <span class="menu-text">My Job Alerts</span>
      ...
      <li>
        <a href="#" >
          ...
          <span class="menu-text">My Connections</span>

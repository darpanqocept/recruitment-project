			...
			<div class="vd_content-section clearfix">
				<div class="panel widget light-widget">
					...
					<div class="panel-body">
						<h2 class="mgbt-xs-20">Job Post Details</h2>
						<form class="form-horizontal"  action="#" role="form" id="register-form">
							<div class="alert alert-danger vd_hidden">
								...
								<div class="alert alert-success vd_hidden">
									...
									<div class="form-group">
										<div class="col-md-12">
											<label class="control-label col-sm-2" >Is Freelance? <span class="vd_red">*</span></label>
											<div id="email-input-wrapper"  class="controls col-sm-6">
									...
									<div class="form-group">
										<div class="col-md-12">
											<label class="control-label  col-sm-2">Summary <span class="vd_red">*</span></label>
									...
									<div class="form-group">
										<div class="col-md-12">
											...
											<div id="company-input-wrapper" class="controls col-sm-6">
												...
												<textarea placeholder="Your Company Co, Ltd." class="width-60 required" required  name="company" id="company" rows="4" cols="50"></textarea>
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-12">
											<label class="control-label  col-sm-2">Discription <span class="vd_red">*</span></label>
											<div id="company-input-wrapper" class="controls col-sm-6">
												

												<textarea placeholder="Your Company Co, Ltd." class="width-60 required" required  name="company" id="company" rows="8" cols="50"></textarea>
											</div>
										</div>
									</div>

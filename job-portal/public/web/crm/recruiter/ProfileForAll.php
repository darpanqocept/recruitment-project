                ...
                <div class="mgtp-20">
                  <table class="table table-striped table-hover" style="font-size: 14px" >
                    <tbody>
                      ...
                      <tr>
                        <td>Email</td>
                        <td>Verified &nbsp;&nbsp;<i style="color:green" class="fa fa-check-circle" aria-hidden="true"></i>
</td>
                      </tr>
                      <tr>
                        <td>Mobile</td>
    ...
    70% Complete (success)
            ...
            <div class="panel widget light-widget">
              <div class="panel-body-list">
                <h3 class="pd-20 mgbt-xs-0"><i class="fa fa-users mgr-10"></i>Connections</h3>
                ...
                <div class="closing text-center" style=""> <a href="#">See All Connections<i class="fa fa-angle-double-right prepend-icon"></i></a> </div>
...
<br>
          <button class="btn btn-primary " data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false" style="width: 100%"  >Endorse</button>
          </div>
          <div class="col-sm-9">
            <div class="tabs widget">
              <ul class="nav nav-tabs widget">
                ...
                <li> <a data-toggle="tab" href="#projects-tab"> Projects <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>    
                         <li> <a data-toggle="tab" href="#company-tab"> Companies <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>    
                <li> <a data-toggle="tab" href="#photos-tab"> Documents <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
              <li> <a data-toggle="tab" href="#post-tab"> Posts <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
              <li> <a data-toggle="tab" href="#article-tab"> Article <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
              
              <li> <a data-toggle="tab" href="#groups-tab"> Groups <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>

              <li> <a data-toggle="tab" href="#jobs-tab"> Job Ads <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
...
<div class="container" style="background-color: white;">
  <div class="row">
    ...
    <div class=" col-md-6 col-xs-12" style="border:1">
      <div class="headline-card tracked loaded" style="height: 600px;">
        <img class="image image-small" src="https://assets.entrepreneur.com/content/16x9/822/1390609103-seed-doesnt-make-series-startups-never-reach-second-funding-round.jpg" />
...
3,50,000  to 6,50,000 INR <br> <i>Title :</i> Tech Manager <br><i>Education:</i> B.Sc(Computer Science)<br><i>Description:</i>   Synechron is hiring for a Java Tech Leads/Senior developers with a strong background in Java/J2EE/Spring/Hibernate/SQL. We are looking for 10+ years of experience. (An earlier experience of working is US /Onsite would be an added advantage.) </span>
  ...
  <div class="detail"><br>
          ...
          <div id="company-tab" class="tab-pane  "  style="margin: 0px !important">
            <div class="pd-20">
             ...
             <div class="panel widget light-widget panel-bd-top">
                  <div class="panel-heading no-title"> </div>
                  <div class="panel-body">
                    <h3 class="mgtp--5"> Companies / Clients Details</h3>
                    <div class="content-list content-blog-small">
                      <ul class="list-wrapper">
                        <li>
                          <div class="menu-icon"> <img alt="example image" src="https://prepnode.com/img/lnt-infotech-logo.png"> </div>
                          <div class="menu-text">
                            <h2 class="blog-title font-bold letter-xs"><a href="#"> Name : Larsen & Toubro: L&T </a></h2>
<!--                             <div class="menu-info">
...
<!--                             <div class="menu-tags  mgbt-xs-15"> Tags: <a href="#"><span class="label vd_bg-yellow">Sports</span></a> <a href="#"><span class="label vd_bg-yellow">Hobby</span></a> <a href="#"><span class="label vd_bg-yellow">Blogs</span></a> <a href="#"><span class="label vd_bg-yellow">Journal</span></a> </div> -->
                                                      ...
                                                      <div class="menu-tags  mgbt-xs-15"> <b>Locations:</b> Mumbai, Pune, Latur, Noida, New Delhi  </div>
                                                                                <div class="menu-tags  mgbt-xs-15"> <b>Domain:</b> Information Technology &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>Number Of Employees:</b> 55.  </div>
                            <p><b>Description:</b> A decade of sustainability practices and reporting has seen L&T post encouraging results across each of the triple bottom-lines - economic, environmental and social. </p>
                            <a class="btn vd_btn vd_bg-green btn-sm" href="#">Read More</a> </div>
                        </li>
                      
                 <li>
                          <div class="menu-icon"> <img alt="example image" src="https://betanews.com/wp-content/uploads/media/40/4016.jpg"> </div>
                          <div class="menu-text">
                            <h2 class="blog-title font-bold letter-xs"><a href="#"> Name : Micro Soft Inc </a></h2>
<!--                             <div class="menu-info">
                              <div class="menu-date font-xs">January 10th, 1987 </div>
                            </div> -->
<!--                             <div class="menu-tags  mgbt-xs-15"> Tags: <a href="#"><span class="label vd_bg-yellow">Sports</span></a> <a href="#"><span class="label vd_bg-yellow">Hobby</span></a> <a href="#"><span class="label vd_bg-yellow">Blogs</span></a> <a href="#"><span class="label vd_bg-yellow">Journal</span></a> </div> -->
     ...
     <li>
                          <div class="menu-icon"> <img alt="example image" src="https://pbs.twimg.com/profile_images/989872585167986688/0VXHVzwR.jpg"> </div>
                          <div class="menu-text">
                            <h2 class="blog-title font-bold letter-xs"><a href="#"> Name : Dell Infosolution </a></h2>
<!--                             <div class="menu-info">
                              <div class="menu-date font-xs">January 10th, 1987 </div>
                            </div> -->
<!--                             <div class="menu-tags  mgbt-xs-15"> Tags: <a href="#"><span class="label vd_bg-yellow">Sports</span></a> <a href="#"><span class="label vd_bg-yellow">Hobby</span></a> <a href="#"><span class="label vd_bg-yellow">Blogs</span></a> <a href="#"><span class="label vd_bg-yellow">Journal</span></a> </div> -->
          ...
          <div id="profile-tab" class="tab-pane  active"  style="margin: 0px !important">
            <div class="pd-20">
  
              <h3 class="mgbt-xs-15 mgtp-10 font-semibold"><i class="icon-user mgr-10 profile-icon"></i> ABOUT</h3>
              <div class="row" style="font-size: 17px ; margin:0px !important"   >
                <div class="col-sm-6">
                  <div class="row mgbt-xs-0"   style="margin: 0px !important" >
                ...
                <div class="col-sm-5">
                  ...
                  <div class="skill-list">
                    <div class="skill-name"> Photoshop </div>
                                    <p style="font-size:11px ; text-align:right"> Endorsed by : 29 Peoples</p>
                  ...
                  <div class="skill-list">
                    <div class="skill-name"> Illustrator </div>                                    <p style="font-size:11px ; text-align:right"> Endorsed by : 59 Peoples</p>
                    <div class="progress  progress-sm">
                  ...
                  <div class="skill-list">
                    <div class="skill-name"> PHP </div>                                    <p style="font-size:11px ; text-align:right"> Endorsed by : 65 Peoples</p>
                    <div class="progress  progress-sm">
                  ...
                  <div class="skill-list">
                    <div class="skill-name"> Javascript </div>                                    <p style="font-size:11px ; text-align:right"> Endorsed by : 66 Peoples</p>
                    <div class="progress  progress-sm">
                  ...
                  <div class="skill-list">
                    <div class="skill-name"> Communication </div>                                    <p style="font-size:11px ; text-align:right"> Endorsed by : 54 Peoples</p>
                    <div class="progress  progress-sm">
                  ...
                  <div class="skill-list">
                    <div class="skill-name"> Writing </div>                                    <p style="font-size:11px ; text-align:right"> Endorsed by : 43 Peoples</p>
                    <div class="progress  progress-sm">
          ...
          <div id="projects-tab" class="tab-pane">
           ...
           <tbody>
              <tr>
             <td>1</td>
             <td><img  src="img/avatar/avatar.jpg" alt="example image"  height="40"></td>                    
             <td>Ashwini </td>
...
<div id="groups-tab" class="tab-pane">
 ...
 <div class="pd-20">
  ...
  <h3 class="mgbt-xs-15 mgtp-10 font-semibold"><i class="fa fa-leaf mgr-10 profile-icon"></i> Pages</h3>
	  <div class="row">
   <div class="col-xs-12 col-sm-6">
    <div class="content-list content-large menu-action-right">
      <ul class="list-wrapper pd-lr-15">
...
<form class="form-horizontal">
                           ...
                           <div class="form-group">
                              ...
                              <div class="">
                                  ...
                                  <!-- col-xs-12 -->
                            <div class="col-xs-9">
                                <input class="form-control" type="text" placeholder="Msg For Group Members">
                            ...
                            <br> <br>
                                                 ...
                                                 <div class="form-group">
                              <label class="col-sm-3 control-label">Group Summary</label>
                              <div class="col-sm-9 controls">

                              
                                                              <textarea rows="3"  class="form-control" placeholder="Group Summary"></textarea>
                              </div>
                            ...
                            <br> <br>
                               ...
                               <div class="form-group">
                              <label class="col-sm-3 control-label">Tag Connection</label>
 ...
 <br><br>               <button class="btn btn-primary nextBtn btn-lg pull-right" type="button" >Next</button>
            </div>
        </div>
    </div>
...
<div class="container bootstrap snippet">
  ...
  <label><input type="checkbox" value=""></label>
                        ...
                        <div class="info">
                            <h4>Shubham Singh</h4>
                            <p class="text-muted">Graphics Designer,  Mumbai</p>
                        </div>
                    </div>
  ...
  <label><input type="checkbox" value=""></label>
    ...
    <div class="row setup-content" id="step-4">
        <div class="col-xs-12">
            ...
            <br><br><br><br>
<div style="text-align: center">
<h4>Your group created successfully &nbsp;&nbsp;<i style="color:green" class="fa fa-check-circle" aria-hidden="true"></i>
</h4>
<h4>All the members and owners got invitation mail.&nbsp;&nbsp;<i style="color:green" class="fa fa-check-circle" aria-hidden="true"></i></h4>
<a href="groups.php">Click Here to access your group </a>
</div>
            <br><br><br><br>

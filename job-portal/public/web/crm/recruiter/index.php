          ...
          <div class="col-sm-9">
            <div class="tabs widget">
              <ul class="nav nav-tabs widget">
                ...
                <li class="active" > <a data-toggle="tab" href="#feeds-tab"> Peoples <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
                                <li > <a data-toggle="tab" href="#jobs-tab"> Jobs <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
                <li> <a data-toggle="tab" href="#friends-tab"> Connections <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
...
<div class="panel-body">
  ...
  <ul class="nav nav-pills">
    <li class="active"><a href="#tab31" data-toggle="tab">Recomended</a></li>
    <li><a href="#tab32" data-toggle="tab">Similar Role</a></li>
    <li><a href="#tab33" data-toggle="tab">From Your Area</a></li>
    <li><a href="#tab34" data-toggle="tab">From Your Domain </a></li>
  </ul>
  <br>
...
<!--       <li> <a href="#"> 
    ...
    <li class="warning"> 
     ...
     <span class="menu-text">  Jonathan Fuzzy
       <span class="menu-info">
         <span class="menu-date">Developer,WizRich</span>
         <span class="menu-date">Mumbai</span>
         <span class="menu-date"><br>455 Connection</span>
         <span class="menu-action">
<!--           <span data-placement="bottom" data-toggle="tooltip" data-original-title="Approve" class="menu-action-icon vd_green vd_bd-green">
            <i class="fa fa-check"></i>
          </span> 
          <span data-placement="bottom" data-toggle="tooltip" data-original-title="Reject" class="menu-action-icon vd_red vd_bd-red">
            <i class="fa fa-times"></i>
                  ...
                  <span data-placement="bottom" data-toggle="tooltip" data-original-title="Approve"  >
        <button type="button" class="btn vd_btn vd_bg-green "  >Unblock</button>
          </span> 
       </span>                                
      </span>                            
    </span> 
  ...
  <span class="menu-text">  Sakura Hinata
    <span class="menu-info">
     <span class="menu-date">CEO,Infosis</span>
     <span class="menu-date"><br>Mumbai</span>
     <span class="menu-date"><br>455 Connection</span>
     <span class="menu-action">                                                                      
<!--       <span class="menu-action">
        <span data-placement="bottom" data-toggle="tooltip" data-original-title="Approve" class="menu-action-icon vd_green vd_bd-green">
...
<div class="panel-body">
  ...
  <ul class="nav nav-pills">
    <li class="active"><a href="#tab41" data-toggle="tab">Friends</a></li>
    <li><a href="#tab42" data-toggle="tab">Pending Request</a></li>
    <li><a href="#tab43" data-toggle="tab">Request Sent</a></li>
    <li><a href="#tab44" data-toggle="tab">Blocked </a></li>
  </ul>
  <br>
  <div class="tab-content  mgbt-xs-20">
...
<button type="button" class="btn vd_btn vd_bg-red "  >Withdraw</button>
        </span>                                
      </span>                            
    </span> 
  </li>    
...
<button type="button" class="btn vd_btn vd_bg-red "  >Withdraw</button>      </span>                                
    </span>       
  </span> 
</li>                                                                                
...
<div class="tab-pane" id="tab44">  <div class="content-grid column-xs-3 column-sm-4 column-md-4 column-lg-6 height-xs-4 mgbt-xs-20">  
 <div>
  <ul class="list-wrapper  ">
<!--       <li> <a href="#"> 
        <span class="menu-icon"><img src="img/avatar/avatar.jpg" alt="example image"></span> 
...
<div class="tab-pane" id="tab45">  <div class="content-grid column-xs-3 column-sm-4 column-md-4 column-lg-6 height-xs-4 mgbt-xs-20">  
 <div>
  <ul class="list-wrapper  ">
<!--       <li> <a href="#"> 
        <span class="menu-icon"><img src="img/avatar/avatar.jpg" alt="example image"></span> 
...
<div class="panel-body">
  ...
  <ul class="nav nav-pills">
    <li class="active"><a href="#tab31" data-toggle="tab">Friends</a></li>
    <li><a href="#tab32" data-toggle="tab">Pending Request</a></li>
    <li><a href="#tab33" data-toggle="tab">Request Sent</a></li>
    <li><a href="#tab34" data-toggle="tab">Blocked </a></li>
  </ul>
  <br>
  <div class="tab-content  mgbt-xs-20">
    <div class="tab-pane active" id="tab31"> 
...
<div class="tab-pane" id="tab34">  <div class="content-grid column-xs-3 column-sm-4 column-md-4 column-lg-6 height-xs-4 mgbt-xs-20">  
 <div>
  <ul class="list-wrapper  ">
<!--       <li> <a href="#"> 
        <span class="menu-icon"><img src="img/avatar/avatar.jpg" alt="example image"></span> 
...
<div class="tab-pane" id="tab35">  <div class="content-grid column-xs-3 column-sm-4 column-md-4 column-lg-6 height-xs-4 mgbt-xs-20">  
 <div>
  <ul class="list-wrapper  ">
<!--       <li> <a href="#"> 
        <span class="menu-icon"><img src="img/avatar/avatar.jpg" alt="example image"></span> 
...
<div id="groups-tab" class="tab-pane">
 <div class="pd-20">
               ...
               <div class="vd_info tr">                     <button class="btn btn-primary " data-toggle="modal" data-target="#myModal"> Create New Group </button> </div>         

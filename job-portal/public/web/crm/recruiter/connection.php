          ...
          <div class="col-sm-12">
            <div class="tabs widget">
              ...
              <div class="tab-content">
                ...
                <div id="feeds-tab" class="tab-pane ">
                  <div class="pd-20">
...
<div id="friends-tab" class="tab-pane active">
 <div class="pd-20">
   ...
   <h3 class="mgbt-xs-15 mgtp-10 font-semibold"><i class="fa fa-users mgr-10 profile-icon"></i> Connections</h3>
...
<div class="panel-body">
  ...
  <ul class="nav nav-pills">
    ...
    <li><a href="#tab32" data-toggle="tab">Company</a></li>
    <li><a href="#tab33" data-toggle="tab">Clients</a></li>
...
</div>    <div class="tab-pane " id="tab33"> 
     <div class="content-grid column-xs-3 column-sm-4 column-md-4 column-lg-6 height-xs-4 mgbt-xs-20">  
       <div>
        <ul class="list-wrapper  ">
<!--       <li> <a href="#"> 

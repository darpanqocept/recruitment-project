...
<div class="vd_content-wrapper">
   ...
   <div class="vd_panel-header">
          ...
          <div class="vd_panel-menu  hidden-xs">
            ...
            <!-- menu -->
   <div class="menu">
              <div data-action="click-trigger"> <span class="menu-icon mgr-10"></span>Group Of Candidates <i class="fa fa-angle-down"></i> </div>
              <div class="vd_mega-menu-content width-xs-2 left-xs" data-action="click-target" style="display: none;">
                <div class="child-menu">
                  <div class="content-list content-menu">
                    <ul class="list-wrapper pd-lr-10">
                      <li> <a href="#"> <div class="menu-icon"><i class=" fa fa-user"></i></div> <div class="menu-text">ABC Solution</div> </a> </li>
...
<div class="panel-body">
  ...
  <ul class="nav nav-pills">
    <li class="active"><a href="#tab31" data-toggle="tab">Blocks</a></li>
    <li><a href="#tab32" data-toggle="tab">Tabular Formate</a></li>
    ...
    <style >
        ...
        *{transition: all .5s ease;-moz-transition: all .5s ease;-webkit-transition: all .5s ease}
        ...
        .my-list:hover .detail{top:0;}
										...
										<div class="panel widget" style="background-color: white" >
...
<select id="cars">
  <option value="volvo">Share With</option>
...
<select id="cars">
  ...
  <option value="audi">100</option>
                          ...
                          <input type="text" placeholder="Search Candidate" style="width:100%" >
...
&nbsp;&nbsp;CephZone<br>
                                                            <b>Experience:</b> 5 yrs<br>
                                                              <b>Title:</b>  UI / UX Developer<br>
																...
																<td class="center">Closer, Time Management, Inbound,<br> Follow Ups, Outbound Calling</td>
																	<td class="center"><i class="fa fa-trash" style="color: red" aria-hidden="true"></i>
</td>

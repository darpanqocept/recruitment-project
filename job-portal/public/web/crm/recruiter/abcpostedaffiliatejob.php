                ...
                <div class="child-menu">
                  <div class="content-list content-menu">
                    <ul class="list-wrapper pd-lr-10">
                      <li> <a href="abcPostedJob.php"> <div class="menu-icon"><i class=" fa fa-user"></i></div> <div class="menu-text">WizRich Solution</div> </a> </li>
                         <li> <a href="xyzPostedJob.php"> <div class="menu-icon"><i class=" fa fa-user"></i></div> <div class="menu-text">Codester Solution</div> </a> </li>
                                             <li> <a href="jklPostedJob.php"> <div class="menu-icon"><i class=" fa fa-user"></i></div> <div class="menu-text">Infosys</div> </a> </li>
                    </ul>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 mgbt-sm-15">
              <div class="vd_status-widget vd_bg-blue widget">
                ...
                <a class="panel-body" href="abcPostedJob.php">
                  <div class="clearfix">
              ...
              <div class="col-lg-3 col-md-6 col-sm-6 mgbt-sm-15">
                <div class="vd_status-widget vd_bg-green widget">
                  ...
                  <a class="panel-body" href="abcsharedjob.php">
                    <div class="clearfix">
                      <span class="menu-icon">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mgbt-xs-15">
                  <div class="vd_status-widget vd_bg-yellow widget">
                    ...
                    <a class="panel-body" href="abcPostedfreelancingjob.php">
                      <div class="clearfix">
                        <span class="menu-icon">
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6 mgbt-xs-15">
                    <div class="vd_status-widget vd_bg-red widget">
                      ...
                      <a class="panel-body" href="abcpostedaffiliatejob.php">
                        <div class="clearfix">
                          <span class="menu-icon">
												...
												<div class="panel-body table-responsive">
														...
														<tbody>
															<tr>
																<td>1</td>
																<td>Sales  Jobs</td>
																<td class="center">Posted Jobs</td>
																
																<td class="center"> <b>Education Background:</b> Science, IT B.tech, Any Tech Course, MBA, etc. <br> <b>Skill:</b> Closer, Time Management,
Inbound, Follow Ups,
Outbound Calling </td>
                                                            <td class="center">9 - 12 Yrs</td>
																<td class="center">9 lakhs  - 10 lakhs  P.A.</td>
																<td class="center">Mumbai</td>
																<td class="center">IT</td>
                                                            <td class="center">WizRich</td>

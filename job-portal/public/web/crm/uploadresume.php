    ...
    <div class="vd_container">
        <div class="vd_content clearfix">
            ...
            <div class="vd_title-section clearfix">
                <div class="vd_panel-header">
                    <h1>Upload Resume</h1>
                    <!--                    <small class="subtitle">Form validation using jQuery Validation: <a href="http://jqueryvalidation.org/">http://jqueryvalidation.org</a>/</small>  -->
                </div>
            </div>
            <div class="vd_content-section clearfix">
                <div class="panel widget light-widget">
                    ...
                    <div class="panel-body">
                        <h2 class="mgbt-xs-20">Upload Resume</h2>
                        <form class="form-horizontal"  action="#" role="form" id="register-form">
                              ...
                              <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <div id="website-input-wrapper"  class="controls col-sm-6">
                                                <input type="text" placeholder=" Name" class="width-60"  name="website" id="website">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="control-label col-sm-2" >User ID <span class="vd_red">*</span></label>
                                            <div id="email-input-wrapper"  class="controls col-sm-6">
                                                <input type="email" placeholder="User ID" class="width-60 required" required  name="email" id="email">
                                            </div>
                                        </div>
                                    </div>
                                  ...
                                  <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="control-label col-sm-2">Contact No. <span class="vd_red">*</span></label>
                                            <div id="password-input-wrapper"  class="controls col-sm-6">
                                                <input type="password" placeholder="Mobile Number" class="width-40 required" required  name="password" id="password">
                                            </div>
                                        </div>
                                    </div>
                                                                                                    ...
                                                                                                    <div class="form-group">
                          <label class="col-sm-2 control-label">Location<i style="color: red">&nbsp;*&nbsp;</i></label>
                          ...
                          <div class="form-group"  >
                            <label class="col-sm-2 control-label">Experience<i style="color: red">&nbsp;*&nbsp;</i></label>
                            <div class="col-sm-4 controls">
                              <div class="">
                                <div >

                                  <input type="email"  placeholder="Experience">
                          ...
                          <!-- col-sm-10 --> 
                                                ...
                                                <div class="form-group"  >
                          <label class="col-sm-2 control-label">Industry<i style="color: red">&nbsp;*&nbsp;</i></label>
                          <div class="col-sm-4 controls">
                            <div class="">
                              <div class="">
                         <div class="col-xs-12">
                         ...
                         <select  id="curr" name="degree_type_id"><option value="" selected="selected">Select the industry you work for</option>
                          ...
                          <!-- col-sm-10 --> 
                                                ...
                                                <div class="form-group"  >
                          <label class="col-sm-2 control-label">Funtional Area<i style="color: red">&nbsp;*&nbsp;</i></label>
                          <div class="col-sm-4 controls">
                            <div class="">
                              <div class="">
                         <div class="col-xs-12">
                         ...
                         <select  id="curr" name="degree_type_id"><option value="" selected="selected">Select the department you work in</option>
                          ...
                          <!-- col-sm-10 --> 
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="control-label  col-sm-2">Upload Resume <span class="vd_red">*</span></label>
                                            <div id="company-input-wrapper" class="controls col-sm-6">
                                                <a class="btn vd_btn  vd_bg-blue" href=""><i class="fa fa-cloud-upload append-icon"><input type="file" style="display: none;"></i> Upload</a>

...
<!-- Mirrored from www.venmond.com/demo/vendroid/index-ecommerce.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2017 07:22:24 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8" />
    <title>Job Seeker For</title>
...
Being the jobseeker view / apply / share jobs & get connected with professionals.
    ...
    <div data-action="remove-navbar" data-original-title="Remove Navigation Bar Toggle" data-toggle="tooltip" data-placement="bottom" class="remove-navbar-button menu"> <i class="fa fa-arrows-h"></i> </div>
      ...
      <div data-action="fullscreen" data-original-title="Remove Navigation Bar and Top Menu Toggle" data-toggle="tooltip" data-placement="bottom" class="fullscreen-button menu"> <i class="glyphicon glyphicon-fullscreen"></i> </div>
          ...
          <div class="vd_title-section clearfix">
            <div class="vd_panel-header">
              <h1>Please fill the details as required</h1>
              ...
              <div class="panel widget light-widget">
                ...
                <form class="form-horizontal" action="#" role="form">
                  <div  class="panel-body">
                    <h2 class="mgbt-xs-20"> Profile Name: <span class="font-semibold">Recruiter</span> </h2>
                    <br/>
                    <div class="row">
                      <div class="col-sm-3 mgbt-xs-20">
                        <div class="form-group">
                          <div class="col-xs-12">
                            <div class="form-img text-center mgbt-xs-15"> <img alt="example image" src="https://www.pngkit.com/png/detail/281-2812821_user-account-management-logo-user-icon-png.png"> </div>
                            <div class=""> 
                          <style>
                            ...
                            <div>
                              <table class="table table-striped table-hover">
                                <tbody>
                                  ...
                                  <tr>
                                    <td>User Rating</td>
                                    <td><i class="fa fa-star vd_yellow fa-fw"></i><i class="fa fa-star-half-o vd_yellow fa-fw"></i><i class=" fa fa-star-o  vd_yellow fa-fw"></i><i class="fa fa-star-o  vd_yellow fa-fw"></i><i class="fa fa-star-o  vd_yellow fa-fw"></i></td>
                                  </tr>
                                  <tr>
                                    <td>Member Since</td>
                                    <td> Jan 07, 2014 </td>
...
<div class="col-xs-5">
                      ...
                      <input type="button" name="del_item" value="Delete" onClick="deleteRow();" />
                                   ...
                                   <div id="Experience_Details">
                        <hr/>
                        <h3 class="mgbt-xs-15">Companies / Clients Info</h3>
                        ...
                        <div class="form-group"  >
                          ...
                          <div class="col-sm-9 controls">
                            ...
                            <!-- col-sm-10 --> 
                                   ...
                                   <div class="form-group"  >
                          <label class="col-sm-3 control-label">Company Logo<i style="color: red">&nbsp;*&nbsp;</i></label>
                          <div class="col-sm-9 controls">
                            <div class="row mgbt-xs-0">
                          ...
                          <div class="col-sm-9 controls">
                            <div class="row mgbt-xs-0">
                              <div class="col-xs-9">
                                    <select  id="degree_type_id" name="degree_type_id"><option value="" selected="selected">Select Locations</option>
                          ...
                          <!-- col-sm-10 --> 
                                              ...
                                              <div class="form-group"  >
                          <label class="col-sm-3 control-label">Numbers Of Employees<i style="color: red">&nbsp;*&nbsp;</i></label>
                          <div class="col-sm-9 controls">
                            <div class="row mgbt-xs-0">
                              <div class="col-xs-9">
                                <input type="text"  placeholder="Numbers Of Employees">
                              </div>
                              <!-- col-xs-12 -->
                                   <!-- <div class="col-xs-2">
                                  <div class="btn-action">
                         ...
                         <select  id="curr" name="degree_type_id"><option value="" selected="selected">Select in which industry your comapny is</option>
                          ...
                          <div class="col-sm-9 controls">
                            <div class="row mgbt-xs-0">
                              <div class="col-xs-9">
                                ...
                                <textarea rows="3" placeholder="Company / Client Discription"></textarea>
                      ...
                      <input type="button" name="del_item" value="Delete" onClick="deleteRow();" />
                        ...
                        <div id="Experience">
                          ...
                          <div class="form-group"  >
                            <label class="col-sm-3 control-label">Project<i style="color: red">&nbsp;*&nbsp;</i></label>
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-5">
                        ...
                        <div class="form-group"  >
                          <label class="col-sm-3 control-label">Client<i style="color: red">&nbsp;*&nbsp;</i></label>
                          <div class="col-sm-9 controls">
                            <div class="row mgbt-xs-0">
                              <div class="col-xs-9">
                      ...
                      <input type="button" name="del_item" value="Delete" onClick="deleteRow();" />
                        ...
                        <div id="Experience_Details">
                        <hr/>
                        <h3 class="mgbt-xs-15">Hiring Info</h3>
                        <SCRIPT src="http://code.jquery.com/jquery-2.1.1.js"></SCRIPT>
                        <SCRIPT>
                          function addMoreExpe() {
                            $("<DIV>").load("inputExperience.php", function() {
                        ...
                        <div id="Experience">
                         ...
                         <select  id="curr" name="degree_type_id"><option value="" selected="selected">Select the industry you hire for (maximum 8)</option>
                         ...
                         <select  id="curr" name="degree_type_id"><option value="" selected="selected">Select the department you hire for (maximum 12) </option>
                        ...
                        <div class="form-group"  >
                         ...
                         <select  id="curr" name="degree_type_id"><option value="" selected="selected">Location you hire for </option>
                      ...
                      <div class="col-sm-9 controls">
                        ...
                        <div class="form-group"  >
                          <label class="col-sm-3 control-label">Company / Client<i style="color: red">&nbsp;*&nbsp;</i></label>
                          <div class="col-sm-9 controls">
                            <div class="row mgbt-xs-0">
                              <div class="col-xs-9">
                                <input type="text"  placeholder="List of client / company you worked for">
                              </div>
                              <!-- col-xs-12 -->
                          ...
                          <div class="col-sm-9 controls">
                            <div class="row mgbt-xs-0">
                              <div class="col-xs-9">
                                ...
                                <textarea rows="3" placeholder="Message you like to give to job seeker you hired"></textarea>
            ...
            <div style="text-align: center;">
              ...
              <button type="button" class="btn vd_btn vd_bg-green btn-lg"  >Submit</button>
...
<!-- Mirrored from www.venmond.com/demo/vendroid/index-ecommerce.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Oct 2017 07:22:25 GMT -->
</html>